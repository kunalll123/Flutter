...
class Greenboxturfpage extends StatefulWidget {
  const Greenboxturfpage({super.key});
  @override
  State createState() => _Greenboxturfpage();
}

class _Greenboxturfpage extends State {
  @override
              ...
              child: Row(
                children: [
                  ...
                  Container(
                    ...
                    child: Image.asset(
                      "assets/all assets/greenboxfbturf1.jpg",
                      fit: BoxFit.cover,
                    ),
                  ),
                  Container(
