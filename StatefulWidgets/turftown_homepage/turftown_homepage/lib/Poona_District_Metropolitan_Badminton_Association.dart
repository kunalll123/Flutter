...
class BadmintonUrAcademy extends StatefulWidget {
  const BadmintonUrAcademy({super.key});
  @override
  State createState() => _BadmintonUrAcademy();
}

class _BadmintonUrAcademy extends State {
  @override
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    color: Colors.amber,
                    child: Image.asset(
                      "assets/all assets/Poona District Metropolitan Badminton Association1.jpg",
                      fit: BoxFit.cover,
                    ),
                  ),
                  Container(
                  ...
                  Container(
                    ...
                    child: Image.asset(
                      "assets/all assets/Poona District Metropolitan Badminton Association4.jpg",
                      fit: BoxFit.cover,
                    ),
                  ),
                ],
