...
class Unitedsports extends StatefulWidget {
  const Unitedsports({super.key});
  @override
  State createState() => _Unitedsports();
}

class _Unitedsports extends State {
  @override
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    color: Colors.amber,
                    child: Image.asset(
                      "assets/all assets/United sports3.jpeg",
                      fit: BoxFit.cover,
                    ),
                  ),
                  Container(
                    ...
                    child: Image.asset(
                      "assets/all assets/United sports2.jpegg",
                      fit: BoxFit.cover,
                    ),
                  ),
                  Container(
