...
import 'package:turftown_homepage/add_cart.dart';
...
class _shoppageState extends State {
  ...
  final List<Product> products = [
    ...
    Product(
      imagePath: 'assets/all assets/tennis.jpg',
      description: 'Yonex Carbonex 8000 Plus Badminton Racquet',
      rating: 4.5,
      price: '₹3450',
    ),
    Product(
      imagePath: 'assets/all assets/shuttle.jpg',
      description: 'Li-Ning G-Tek 90 Badminton Racquet',
      rating: 4.2,
      price: '₹2999',
    ),
    Product(
      imagePath: 'assets/all assets/racquet.jpg',
      description: 'Victor Brave Sword 1900 Badminton Racquet',
      rating: 4.3,
      price: '₹4300',
    ),
  ];
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: SizedBox(
                  height: 290, // Height of the Container
