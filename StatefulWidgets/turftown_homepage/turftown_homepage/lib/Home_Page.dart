...
import 'package:turftown_homepage/JoinPage.dart';
import 'package:turftown_homepage/Rewards_Page.dart';
import 'package:turftown_homepage/Tennis_host.dart';
import 'package:turftown_homepage/Venue.dart';
import 'package:turftown_homepage/badminton_host.dart';
import 'package:turftown_homepage/chatscreen.dart';

import 'package:turftown_homepage/host_page.dart';
import 'package:turftown_homepage/profile.dart';
import 'package:turftown_homepage/shop_page.dart';

class TurfTown extends StatefulWidget {
  final String fetchedname;
  const TurfTown({super.key, required this.fetchedname});

  @override
  State createState() => _TurfTown();
}

class _TurfTown extends State {
  @override
