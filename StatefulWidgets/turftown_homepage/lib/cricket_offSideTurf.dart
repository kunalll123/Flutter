...
class CricketOffSide extends StatefulWidget {
  const CricketOffSide({super.key});
  @override
  State createState() => _CricketOffSide();
}

class _CricketOffSide extends State {
  @override
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    color: Colors.amber,
                    child: Image.asset(
                      "assets/all assets/offisdeturf2.jpg",
                      fit: BoxFit.cover,
                    ),
                  ),
                  Container(
