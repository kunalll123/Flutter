...
class CricketKodreGround extends StatefulWidget {
  const CricketKodreGround({super.key});
  @override
  State createState() => _CricketKodreGround();
}

class _CricketKodreGround extends State {
  @override
              ...
              child: Row(
                children: [
                  ...
                  Container(
                    ...
                    color: Colors.black,
                    child: Image.asset(
                      "assets/all assets/kodrecricket3.jpg",
                      fit: BoxFit.cover,
                    ),
                  ),
                ],
