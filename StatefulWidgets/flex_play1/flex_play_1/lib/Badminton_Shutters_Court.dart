...
class BadmintonShuttersCourt extends StatefulWidget {
  const BadmintonShuttersCourt({super.key});
  @override
  State createState() => _BadmintonShuttersCourt();
}

class _BadmintonShuttersCourt extends State {
  @override
